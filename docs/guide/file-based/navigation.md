---
title: Navigation (File-based)
description: Navigate between file-based routes with links, the p() helper, the navigate() function, and block navigation to prevent lost changes.
---
